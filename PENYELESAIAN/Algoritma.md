...
2. Fungsi `tampilkanMenu()`:
   ...
   menu yang dipilih,ada 6 menu pilihan.
...
``
   ...
   Jika pengguna memasukkan pilihan yang tidak valid (misalnya bukan angka 1-6), program akan memberikan pesan "Pilihan tidak valid" dan meminta 
...
4. Setelah fungsi penambahan mahasiswa dibuat, untuk melihat data yang telah dimasukkan, buat fungsi untuk menampilkan daftar mahasiswa yang 
   berisi:
...
5. Untuk mencari data mahasiswa berdasarkan NIM, buat fungsi yang berisi:
...
6. Untuk menghapus data mahasiswa berdasarkan NIM, buat fungsi dengan langkah-langkah sebagai berikut:
...
7. Jika perlu mengubah data mahasiswa, buat fungsi untuk mengubah data mahasiswa berdasarkan NIM dengan langkah-langkah sebagai berikut:
...
8. Untuk menyimpan data mahasiswa ke dalam file, buat fungsi dengan langkah-langkah sebagai berikut:
...
9. Untuk membaca data mahasiswa dari file, buat fungsi dengan langkah-langkah sebagai berikut:
...
10. Langkah terakhir adalah menambahkan fungsi `main` sebagai program utama yang mengatur interaksi dengan pengguna untuk mengelola data 
